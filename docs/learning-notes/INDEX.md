...
- [03 — Self-Healing](03-self-healing.md) — three layers of defense (retry, JSON repair, structured surrender), the `down=True` sentinel, routing around dead agents, the referee fallback trap, and why self-heal instead of crash-and-restart. *(Self-correction is queued for note 04.)*
